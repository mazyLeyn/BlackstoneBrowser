...
class MainActivity : AppCompatActivity() {
    ...
    private fun applyPrivateModeUI() {
        ...
        val bgColor = if (isPrivateMode) {
            ...
            androidx.core.content.ContextCompat.getColor(this, R.color.background_dark)
        }
        ...
        btnPrivateMode.imageTintList = android.content.res.ColorStateList.valueOf(
            if (isPrivateMode) accentColor else androidx.core.content.ContextCompat.getColor(this, R.color.icon_gray)
        )
